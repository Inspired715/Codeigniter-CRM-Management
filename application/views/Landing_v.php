            ...
            <nav class="navbar navbar-expand-lg py-0">
                <div class="container">
                    <a class="navbar-brand me-0 py-0" href="<?php echo base_url()?>">
                        <img src="<?php echo base_url('assets/img/dark-logo.png')?>" alt="img-fluid"
                            style="width:195px;padding-top:5px;">
                    </a>
                        ...
                        <div class="col-xl-6">
                            <div class="hero-content my-11 my-xl-0">
                                <h6 class="d-flex align-items-center gap-2 fs-4 fw-semibold mb-3 aos-init aos-animate"
                                    data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000"><i
                                        class="ti ti-rocket text-secondary fs-6"></i>Increase revenue, nurture customer relationships &
analyse performance with our award-winning CRM platform</h6>
                                <h1 class="fw-bolder mb-8 fs-13 aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="400" data-aos-duration="1000">Most powerful &amp; <span
                                        class="text-primary"> All in One CRM</span>
                                        Affordable</h1>
                                <p class="fs-5 mb-5 text-dark fw-normal aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="600" data-aos-duration="1000">Make the most of Agile's modern features & integrations, easy implementation and great support at an affordable price.</p>
                                <div class="d-sm-flex align-items-center gap-3 aos-init aos-animate" data-aos="fade-up"
                                ...
                                <div class="d-flex flex-row">
                                    <div class="">
                                        <div class="banner-img-1 slideup">
                                            <img src="<?php echo base_url('assets/img/bannerimg1.png')?>" alt=""
                                                class="img-fluid">
                                        </div>
                                        <div class="banner-img-1 slideup">
                                            <img src="<?php echo base_url('assets/img/bannerimg1.png')?>" alt=""
                                    ...
                                    <div class="">
                                        <div class="banner-img-2 slideDown">
                                            <img src="<?php echo base_url('assets/img/bannerimg2.png')?>" alt=""
                                                class="img-fluid">
                                        </div>
                                        <div class="banner-img-2 slideDown">
                                            <img src="<?php echo base_url('assets/img/bannerimg2.png')?>" alt=""
            ...
            <section class="production pb-10" id="production-template">
                <div class="container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="sliding-wrapper position-relative overflow-hidden">
                        <div class="slide-background d-flex flex-row w-100">
                            <div class="slide">
                                <img src="<?php echo base_url('assets/img/slider-group.png')?>" alt="slide" height="100%">
                            </div>
                            <div class="slide">
                                <img src="<?php echo base_url('assets/img/slider-group.png')?>" alt="slide" height="100%">
                            </div>
            ...
            <section class="features-section py-5">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center aos-init" data-aos="fade-up" data-aos-delay="600"
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4 col-lg-3 aos-init" data-aos="fade-up" data-aos-delay="800"
                            data-aos-duration="1000">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 aos-init" data-aos="fade-up" data-aos-delay="1000"
                            data-aos-duration="1000">
                            <div class="text-center mb-5">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-5 col-xl-5">
                            <div class="text-center text-lg-end">
                                <img src="<?php echo base_url('assets/img/business-woman-checking-her-mail.png')?>"
                                    alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <div class="text-center">
                            <p class="mb-0 text-dark">All rights reserved by Seamotech. Designed &amp; Developed by Seamotech</p>
                        </div>
                    </div>
                </div>
            </div>
